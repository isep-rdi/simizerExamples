...
/**
 *
 * @author isep Estimation de latence:
...
public class RunExample {
    ...
    public static Queue<Request> getRequestQueue(String requestfile, String requestDescFile) {
        ...
        try {
            ...
            Logger.getLogger(RunExample.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(0);
        }
    ...
    public static void run(String nodeFile, String reqDesc, String wlFile, String resFile, String policyName) {
        ...
        // on cree 2 reseaux:
        //Internet
        Network internet = new Network(nodeMap, new UniLaw(5));
        //LAN
        Network lan = new Network(nodeMap, new UniLaw(1));
        ...
        for (int i = 1; i < 11; i++) {
            System.out.print(RunExample.storetime[i] + ";");
        }
        System.out.println("");
    ...
    private static void runClientSim(String lawConfFile, String rDescFile, String resFile, String nodeFile, String policyName, long endSim, int maxUsers) {
        ...
        Network internet = new Network(new UniLaw(5));
        //LAN
        Network lan = new Network(new UniLaw(1));
        // policy & lb setup :
        Policy pol = null;
        try {
            pol = (Policy) Class.forName(policyName).newInstance();
