...
/**
 * HACK Class, wrapper copy over Wekas' IterativeSimpleKMeans class. Adds the
 * ability to set some starting cluster centroids.
 *
 * @author slefebvre
 */
 ...
 */
public class IterativeSimpleKMeans
    ...
    /**
     * decision table for centers.
     */
    private HashMap centersMap;

    /**
     * the default constructor
     */
    public IterativeSimpleKMeans() {
        super();
    ...
    public void buildClusterer(Instances data) throws Exception {
        ...
        if (m_ClusterCentroids.numInstances()>0) {
            ...
            //part de la fin du Data Set. swappe le centre identifié avec la derniere
    ...
    /**
     * Gets the current settings of IterativeSimpleKMeans
     *
     ...
     *
     * @param argv should contain the following arguments: <p> -t training file
     * [-N number of clusters]
     */
    public static void main(String[] argv) {
        runClusterer(new IterativeSimpleKMeans(), argv);
    }
}